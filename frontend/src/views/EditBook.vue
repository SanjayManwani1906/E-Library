...
function data() {
    fetch("http://127.0.0.1:5000/getbook/" + route.params.bookid + "?token=" + route.params.token, {
        method: "GET",
        headers: {
...
function editBook() {
    ...
    fetch("http://127.0.0.1:5000/updatebook/" + route.params.bookid + "?token=" + route.params.token, {
        method: "POST",
...
<template>
    <main>
        ...
        <div align='center'>
            ...
            <br>
            <br>
            <button @click="editBook" class="new" style="margin-bottom:10px;margin-top:10px;font-size: 20px;">
                Save Book
            </button>
